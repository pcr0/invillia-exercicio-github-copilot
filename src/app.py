...
activities = {
        ...
        "Swimming Club": {
            "description": "Improve swimming techniques and participate in friendly meets",
        ...
        "Drama Club": {
            "description": "Develop acting skills and prepare school theater performances",
            "schedule": "Thursdays, 4:30 PM - 6:00 PM",
            "max_participants": 20,
            "participants": ["sara@mergington.edu", "noah@mergington.edu"]
        },
        "Science Olympiad": {
            "description": "Study advanced science topics and compete in academic challenges",
